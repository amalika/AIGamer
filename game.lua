...
function changeAccount()
	...
	while localFlag do
		...
		sysLog("changeAccount 识别结果: " .. page)
		if page == "关闭状态" then
			F单击(x1, y1) -- 打开工具栏
        ...
        elseif page == "登录中页面" then
            -- 退出切换账号
            localFlag = false
        elseif page == "展开账号" then
			local accountOOk = false
			repeat
				mSleep(math.random(400,800))
				print("切换账号 滑动.....")
				touchDown(1, 1391, 479)
				mSleep(math.random(100, 250))
				touchMove(1, 1391, 279)
				...
				local ax, ay = F多点找色( { { 665, 776, 665+415, 776+223 }, "0|0|0xffffff,3|0|0xfd4e4e,7|0|0xffffff,10|13|0xfd4e4e,10|27|0xffffff,10|32|0xffffff,28|30|0xfff8f8,28|26|0xfff8f8,49|26|0xfc8383,53|26|0xffffff,67|28|0xfb4f4f,71|28|0xffffff,219|28|0xffffff,223|28|0xfb4f4f,233|28|0xffeaea,233|19|0xfb4f4f,233|12|0xffffff,233|10|0xfb4f4f,233|8|0xffffff,233|-4|0xfb4f4f",80})
