...
-- 检查移动参数
indexRange = {
	{188,86,188+154,86+36},{"0xd0c5b5-0x000000","0xb1a999-0x000000","0x969280-0x000000"},"0123456789,()"
}
testRange={
	{968,8,968+99,8+56},{"0xffffff-0x000000"},"0123456789,()"
}
-- ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑全局是否移动标识↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
...
function FIsMove()
	...
	local ret1 = screen.getOrientation
	local code, text = ocr:getText({
			...
			print(testRange[2]),
--			rect = {0,0,200,275},
--			diff =  {"0xffffff-0x1000000"}, -- 时间颜色为纯黑
...
--		showHUD(myHUDid,"移动中",28,"0xFFFF00FF","my.png",2,indexRange[1][1],indexRange[1][2],indexRange[1][3],indexRange[1][4])
		while true do
			mSleep(300,800)
			FIsMove()
			if not isMove then
